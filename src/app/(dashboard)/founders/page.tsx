            ...
            >
              ...
              <div className="flex items-start gap-4 relative">
                ...
                <div className="flex-1 min-w-0">
                  <h2 className="text-xl font-bold text-foreground truncate group-hover:text-[#00C6D8] transition-colors flex items-center gap-2">
                    {founder.name}
                    <span className="text-xs font-bold text-[#00C6D8] bg-[#00C6D8]/10 px-1.5 py-0.5 rounded-full border border-[#00C6D8]/20">
                      {founder.username}
                    </span>
                  </h2>
