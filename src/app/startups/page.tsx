        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-[#00C6D8]/50 transition-all"
            />
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {startups.map((startup) => (
              <Link
                ...
                className="group flex flex-col bg-black/40 backdrop-blur-xl border border-white/5 rounded-[2rem] overflow-hidden hover:border-[#00C6D8]/30 transition-all duration-300"
              >
                ...
                <div className="p-6 md:p-8 flex-1 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-[#00C6D8] to-[#8DEE5F] p-[1.5px] shrink-0">
                      <div className="w-full h-full bg-black rounded-xl flex items-center justify-center font-bold text-white text-sm">
                        {startup.startupName.charAt(0)}
                      </div>
                    </div>
                    <div>
                      <h3 className="text-xl font-bold text-white group-hover:text-[#00C6D8] transition-colors">
                        {startup.startupName}
                      </h3>
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {startup.tags.slice(0, 3).map((tag) => (
                      <span
                        key={tag}
                        className="px-2.5 py-1 rounded-md bg-white/5 text-[10px] font-semibold text-zinc-300 border border-white/5"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <div className="mt-auto pt-4 border-t border-white/5 flex items-center justify-between">
                    ...
                    <div className="p-2 rounded-full bg-white/5 group-hover:bg-[#00C6D8]/20 transition-colors">
                      <ArrowUpRight className="w-4 h-4 text-zinc-400 group-hover:text-[#00C6D8]" />
                    </div>
                  </div>
                </div>
              </Link>
