...
export default function SignupPage() {
  return (
    <div className="flex flex-col items-center justify-center space-y-6">
      <Link href="/" className="flex items-center gap-2 mb-4 group hover:scale-105 transition-transform">
         ...
         <span className="text-xl font-bold tracking-tight text-white">Thrivo</span>
      </Link>
